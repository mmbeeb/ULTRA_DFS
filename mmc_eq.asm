...
.VID_DRIVE_INDEX0	SKIP 4	;10A0-10A3 Bits 0 to 7 of DRIVE_INDEX.
.VID_DRIVE_INDEX4	SKIP 4	;10A4-10A7 Bits 8 to 15 of DRIVE INDEX.
.VID_MMC_SECTOR		SKIP 3	;10A8-10AA MMB file first sector.
.VID_MMC_CIDCRC		SKIP 2	;10AB-10AC CRC of MMC card's CID.
